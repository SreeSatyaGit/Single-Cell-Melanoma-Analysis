...
k.Km_s6k          = 0.4909;
k.hill_coeff      = 2.1992;
k.k_4ebp1_act     = 0.8062;
k.k_4ebp1_comp    = 0.2251;
k.k_4ebp1_deg     = 0.4041;
k.k_akt_act       = 0.9456;
k.k_akt_deg       = 0.3676;
k.k_akt_mek       = 0.1239;
k.k_akt_raf       = 0.5548;
...
k.k_dusp_cat      = 0.5842;
k.k_dusp_deg      = 0.4929;
k.k_dusp_synth    = 0.7211;
k.k_egfr_dephos   = 0.3165;
k.k_egfr_phos     = 0.3984;
k.k_erk_act       = 1.1651;
k.k_erk_deg       = 0.4574;
k.k_erk_pi3k      = 0.5132;
k.k_erk_rtk       = 0.2578;
k.k_erk_sos       = 0.4730;
k.k_her_dephos    = 0.2408;
k.k_her_phos      = 0.3220;
k.k_igf_dephos    = 0.2933;
k.k_igf_phos      = 0.1991;
k.k_mek_act       = 0.9037;
k.k_mek_deg       = 0.4464;
k.k_mek_inhib     = 0.2379;
k.k_raf_pi3k      = 0.1507;
k.k_s6k_act       = 0.9149;
k.k_s6k_deg       = 0.4571;
k.k_s6k_irs       = 0.7012;
k.k_s6k_mtor      = 0.3017;
k.k_vem_paradox   = 0.1413;
k.n_dusp          = 2.5251;
k.vem_optimal     = 0.1481;
